--- 
title: "ensemblemerge package documentation"
author: "Erik Skie"
date: "2021-03-29"
...
link-citations: yes
description: This is a reference for the ensemblemerge package for scRNAseq integration.
---
...
knitr::write_bib(c(
  .packages(), 'ensemblemerge', 'knitr', 'rmarkdown'
), 'packages.bib')
```
